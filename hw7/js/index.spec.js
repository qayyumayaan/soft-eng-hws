const fs = require('fs');
const { FindAvailableDates, Publisher, MakeReservation, LookupReservations, CancelReservation, readCalendar, initiateMasterSchedule, dateIsValid, methodIsValid, sortSchedule, notifyDoctor, notifySecretary, logCancellationForAudit, cancellationPublisher } = require('./processor.js');
...
describe("Calendar System Tests", () => {
    ...
    describe("Notification Functions", function() {
        ...
        describe("notifyDoctor", function() {
          it("should log a notification for the doctor", function() {
            notifyDoctor();
            expect(console.log).toHaveBeenCalledWith("Notified doctor.");
          });
        ...
        describe("notifySecretary", function() {
          it("should log a notification for the secretary", function() {
            notifySecretary();
            expect(console.log).toHaveBeenCalledWith("Notified secretary");
          });
        ...
        describe("logCancellationForAudit", function() {
          it("should log a cancellation for audit", function() {
            logCancellationForAudit();
            expect(console.log).toHaveBeenCalledWith("Logged cancellation for audit");
          });
    ...
    // Remember to define and export the `cancellationPublisher` instance, and the notify functions 
    // (`notifyDoctor`, `notifySecretary`, and `logCancellationForAudit`) in your main module.
